...
from .output_parser import CMD_ZeroShotOutputParser


class CMD_ZeroShotAgent(ZeroShotAgent):
    ...
    def from_llm_and_tools(
        ...
        output_parser: Optional[AgentOutputParser] = CMD_ZeroShotOutputParser(),
        prefix: str = PREFIX,
        suffix: str = SUFFIX,
        format_instructions: str = FORMAT_INSTRUCTIONS,
        question_prompt: str = QUESTION_PROMPT,
