...
from .agent import CMD_ZeroShotAgent
from .executor import CMD_AgentExecutor
...
class ChatMolData:
    def __init__(
        ...
        # Initialize agent
        self.agent_executor = CMD_AgentExecutor.from_agent_and_tools(
            tools=tools,
            agent=CMD_ZeroShotAgent.from_llm_and_tools(
                self.llm,
                tools,
                suffix=SUFFIX,
